    ...
    return (
        <div>
            ...
            <div className="w-[75%] mx-auto py-3 dark:text-white">
                ...
                <br />
                <p>
                    This website is operated by <b>Akshay EdTech Pvt Ltd.</b>{" "}
                    Throughout the site, the terms “we”, “us” and “our” refer to{" "}
                    <b>Akshay EdTech Pvt Ltd. Akshay EdTech Pvt Ltd</b> offers
                ...
                <p>
                    ...
                    (b) changes to conform and adapt to the technical
                ...
                <p>
                    ...
                    on this site is provided for general information only and
                ...
                <br />
                <b>
                    <h1>SECTION 5 - PRODUCTS OR SERVICES</h1>
                </b>
                <br />
                <p>
                ...
                <p>
                    ...
                    change at any time without notice, at our sole discretion of
                ...
                <p>
                    ...
                    state regulations, rules, laws, or local ordinances; <br />
                    (d) to infringe upon or violate our intellectual property
                    rights or the intellectual property rights of others; <br />
                    ...
                    prohibited uses.
                    <br />
                    (l) to share access or account details, which will result in
                    the temporary or permanent blocking of the account;
                    <br />
                    (m) to use the course content only for individual use and
                    not to share it.
                </p>
                <br />
                <hr />
                ...
                <br />
                <p>
                    In no case shall <b>Akshay EdTech Pvt Ltd,</b> our
                ...
                <p>
                    ...
                    <b>Akshay EdTech Pvt Ltd</b> and our parent, subsidiaries,
                ...
                <p>
                    ...
                    in accordance with the laws of India and the jurisdiction of
